...
export const listCustomerOrders = () => async (dispatch, getState) => {
	try {
		...
		const { data } = await axios.get(`${API_ENDPOINT}/order/get-customer-orders/${customerInfo._id}`, config);
...
export const adminCustomerOrders = () => async (dispatch, getState) => {
	try {
		...
		const { data } = await axios.get(`${API_ENDPOINT}/order/get-admin-orders`, config);
...
export const updateOrderStatusAction = (id, status) => async (dispatch, getState) => {
	try {
		...
		const { data } = await axios.put(`${API_ENDPOINT}/order/order-admin/${id}`, { status }, config);
...
export const customerUpdateOrderStatusAction = (id, status) => async (dispatch, getState) => {
	try {
		...
		const { data } = await axios.put(`${API_ENDPOINT}/order/order-customer-status/${id}`, { status }, config);
