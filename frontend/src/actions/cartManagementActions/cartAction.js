...
export const listCart = () => async (dispatch, getState) => {
	try {
		...
		const { data } = await axios.get(`${API_ENDPOINT}/cart-cart/${customerInfo._id}`, config);
...
export const updateCartAction = (id, quantity) => async (dispatch, getState) => {
	try {
		...
		const { data } = await axios.put(`${API_ENDPOINT}/cart-cart/${id}`, { quantity }, config);
...
export const deleteCartAction = (id) => async (dispatch, getState) => {
	try {
		...
		const { data } = await axios.delete(`${API_ENDPOINT}/cart-cart/${id}`, config);
...
export const deleteAllCartAction = (id) => async (dispatch, getState) => {
	try {
		...
		const { data } = await axios.delete(`${API_ENDPOINT}/cart-cart/all/${id}`, config);
