...
export const vendorLogin = (email, password) => async (dispatch) => {
	try {
		...
		const { data } = await axios.post(`${API_ENDPOINT}/vendor/login`, { email, password, isAdmin: false }, config);
...
export const vendorViewProfile = (vendor) => async (dispatch, getState) => {
	try {
		...
		//call the backend route
		const { data } = await axios.get(`${API_ENDPOINT}/vendor/view`, vendor, config);
...
export const vendorUpdateProfile = (vendor) => async (dispatch, getState) => {
	try {
		...
		//call the backend route
		const { data } = await axios.put(`${API_ENDPOINT}/vendor/edit`, vendor, config);
...
export const vendorDeleteProfile = (vendor) => async (dispatch, getState) => {
	try {
		...
		//call the backend route
		const { data } = await axios.delete(`${API_ENDPOINT}/vendor/delete`, config);
...
export const vendorsList = () => async (dispatch, getState) => {
	try {
		...
		//call the backend route
		const { data } = await axios.get(`${API_ENDPOINT}/admin/vendors`, config);
	...
	async (dispatch, getState) => {
		try {
			...
			const { data } = await axios.get(
				`${API_ENDPOINT}/admin/vendor/profile/view/${id}`,
				{
					id,
					name,
					telephone,
	...
	async (dispatch, getState) => {
		try {
			...
			const { data } = await axios.put(
				`${API_ENDPOINT}/admin/vendor/profile/edit/${id}`,
				{
					name,
					telephone,
					homeAddress,
...
export const vendorDeleteProfileById = (id) => async (dispatch, getState) => {
	try {
		...
		//call the backend route
		const { data } = await axios.delete(`${API_ENDPOINT}/admin/vendor/profile/view/${id}`, config);
