...
export const customerRegister = (name, telephone, address, email, password, pic) => async (dispatch) => {
	try {
		...
		//call the backend route
		const { data } = await axios.post(
			`${API_ENDPOINT}/customer/register`,
			{
				name,
				telephone,
				address,
...
export const customerViewProfile = (customer) => async (dispatch, getState) => {
	try {
		...
		//call the backend route
		const { data } = await axios.get(`${API_ENDPOINT}/customer/view`, customer, config);
...
export const customerUpdateProfile = (customer) => async (dispatch, getState) => {
	try {
		...
		//call the backend route
		const { data } = await axios.put(`${API_ENDPOINT}/customer/edit`, customer, config);
...
export const customerDeleteProfile = () => async (dispatch, getState) => {
	try {
		...
		//call the backend route
		const { data } = await axios.delete(`${API_ENDPOINT}/customer/delete`, config);
...
export const customersList = () => async (dispatch, getState) => {
	try {
		...
		//call the backend route
		const { data } = await axios.get(`${API_ENDPOINT}/admin/customers`, config);
	...
	(id, name, telephone, address, email, password, pic) => async (dispatch, getState) => {
		try {
			...
			const { data } = await axios.get(
				`${API_ENDPOINT}/admin/customer/profile/view/${id}`,
				{
					id,
					name,
					telephone,
	...
	(id, name, telephone, address, email, password, pic, message) => async (dispatch, getState) => {
		try {
			...
			const { data } = await axios.put(
				`${API_ENDPOINT}/admin/customer/profile/edit/${id}`,
				{
					name,
					telephone,
					address,
...
export const customerDeleteProfileById = (id) => async (dispatch, getState) => {
	try {
		...
		//call the backend route
		const { data } = await axios.delete(`${API_ENDPOINT}/admin/customer/profile/view/${id}`, config);
