...
export const productsListForVendor = () => async (dispatch, getState) => {
	try {
		...
		const { data } = await axios.get(`${API_ENDPOINT}/products/vendor/product/get`, config);
...
export const productsListForAdmin = () => async (dispatch, getState) => {
	try {
		...
		//call the backend route
		const { data } = await axios.get(`${API_ENDPOINT}/products/admin/product/get`, config);
	...
	async (dispatch, getState) => {
		try {
			...
			const { data } = await axios.post(
				`${API_ENDPOINT}/products/vendor/product/add`,
				{
					vendorEmail,
					title,
					category,
	...
	async (dispatch, getState) => {
		try {
			...
			const { data } = await axios.put(
				`${API_ENDPOINT}/products/vendor/product/get/${id}`,
				{
					vendorEmail,
					title,
					category,
...
export const deleteProductByVendor = (id) => async (dispatch, getState) => {
	try {
		...
		//call the backend route
		const { data } = await axios.delete(`${API_ENDPOINT}/products/vendor/product/get/${id}`, config);
...
export const deleteProductByAdmin = (id) => async (dispatch, getState) => {
	try {
		...
		//call the backend route
		const { data } = await axios.delete(`${API_ENDPOINT}/products/admin/product/get/${id}`, config);
